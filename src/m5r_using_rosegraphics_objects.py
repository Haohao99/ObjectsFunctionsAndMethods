...
#                rg.Circle.attach_to(),rg.Circle.clone(),rg.Circle.detach_from()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                rg.Circle.fill_color,rg.Circle.center,rg.Circle.outline_color
#
